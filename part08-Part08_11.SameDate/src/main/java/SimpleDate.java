...
public class SimpleDate {
    ...
    public boolean equals(Object object) {
        ...
        // Cast the object to a SimpleDate since we know it's of that type
        SimpleDate comparedObject = (SimpleDate) object;
        
        // Check if the day, month, and year of the compared objects are equal
        if (this.day == comparedObject.day && this.month == comparedObject.month && this.year == comparedObject.year) {
            return true; // If objects are equal
        }

        return false; // Otherwise, when not equal
    }
}
